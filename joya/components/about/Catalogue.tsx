...
const Catalogue = ({ t }: { t: TFunction }) => {
    ...
    return (
        <div id="tours" className="flex gap-5 flex-col items-center text-center">
          ...
          <a href={i18n?.language === 'en' ? "/assets/JOYA_Catalogue_EN.pdf" : "/assets/JOYA_Catalogue_VN.pdf" } target="_blank" className="bg-primary-regular hover:bg-primary-dark px-6 py-4 rounded-[30px] text-neutral-100 font-semibold text-base leading-5">
            {t('downloadCatalogue')}
          </a>
