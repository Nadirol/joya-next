...
const Categories = ({ t }: { t: TFunction }) => {
    return (
        <div className="bg-primary-extra-light rounded-[30px] p-8 xl:px-[6.375rem] py-7 flex flex-col gap-[2rem]">
            ...
            <div className="flex gap-4 flex-col">
                <div className="grid gap-9 md:grid-cols-category-row-1">
                    <div className="flex flex-col justify-between p-[18px] rounded-2xl shadow-card bg-white min-h-[263px]">
                        ...
                        <button className="mb-1 ml-auto text-neutral-900 font-medium text-xl">{t('explore')}</button>
                    </div>
                    <div className="flex flex-col justify-between p-[18px] rounded-2xl shadow-card bg-white min-h-[263px]">
                        <div className="mb-2">
