...
const Values = ({ t }: { t: TFunction }) => {
    return (
        <div className="bg-white flex gap-2.5 md:absolute md:bottom-0 md:right-1/2 md:translate-x-1/2 md:translate-y-1/2 
        ...
        <div className="flex gap-2.5 flex-col items-center text-center">
            ...
            <h1 className="text-neutral-900 font-medium text-sm xl:text-xl xl:leading-[25px]">{t('valueTitle1')}</h1>
        ...
        <div className="flex gap-2.5 flex-col items-center text-center">
            ...
            <h1 className="text-neutral-900 font-medium text-sm xl:text-xl xl:leading-[25px]">{t('valueTitle2')}</h1>
            <p className="text-neutral-900 font-regular text-[0.625rem] w-[210px] xl:text-xs xl:w-[315px]">
            {t('valueParagraph2')}
            </p>
        </div>
        <div className="flex gap-2.5 flex-col items-center text-center">
            ...
            <h1 className="text-neutral-900 font-medium text-sm xl:text-xl xl:leading-[25px]">{t('valueTitle3')}</h1>
            <p className="text-neutral-900 font-regular text-[0.625rem] w-[210px] xl:text-xs xl:w-[315px]">
            {t('valueParagraph3')}
            </p>
        </div>
