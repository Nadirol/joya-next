import { arrowRightIcon, phoneIcon } from "@/public/assets";
...
const CallWidget = ({ t }: { t: TFunction }) => {
    ...
    return (
        <div className="fixed right-4 md:right-8 bottom-12 md:bottom-24">
            <div className="relative">
                ...
                after:rounded-[100%] after:bg-red-400
                [&:hover]:after:scale-[1.4] [&:hover]:after:opacity-0 relative z-10" 
                onClick={() => setCallNumberVisible(prevState => !prevState)} ref={buttonRef}>
