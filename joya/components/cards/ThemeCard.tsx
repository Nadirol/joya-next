...
{ image: StaticImageData, title: string }) => {
    ...
    return (
        <div className="relative z-20 flex justify-center items-center bg-neutral-800 px-6 md:px-12 py-5 md:py-10 rounded-[1.125rem] overflow-hidden
        before:absolute before:top-0 before:left-0 before:z-10 before:bg-filter-dark before:w-full before:h-full">
            <h1 className="relative z-20 text-white font-semibold text-sm md:text-xl">{title}</h1>
