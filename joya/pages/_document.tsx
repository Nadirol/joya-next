  ...
  return (
    <Html className="scroll-smooth scroll-pt-[6rem] md:scroll-pt-[9rem] xl:scroll-pt-12">
      <Head>
        ...
        <meta name="description" content="Joya is a traveling age ncy that specializes in providing high-quality travel services to companies and corporates, as well as to high-end profiles."/>
